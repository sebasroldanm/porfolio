                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Ingrese Correo electrónico" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                   ...
                                   placeholder="Establecer una contraseña" name="password" tabindex="2" required>
                            <div class="invalid-feedback">
